...
#Region Service
	...
	Strings.Insert("S_005", NStr("ru='Настройки интеграции с наименованием %1 не найдены.';
...
#Region ErrorMessages
	...
	Strings.Insert("Error_074", NStr("fr='Le transfert d''argent dans la même devise est disponible uniquement quand les montants sont égaux.';
	...
	// %1 - 1 %2 - 2
	Strings.Insert("Error_078", NStr("ru='Количество [%1] по строке не совпадает с количеством [%2] заполненным по серийным номерам. ';
	...
	Strings.Insert("Error_103", NStr("ru='%1 неопределен.';
		|en='%1 is undefined.';
...
#Region QuestionToUser
	...
	Strings.Insert("QuestionToUser_013", NStr("ru='Обновить заполненные цены?';
	...
	Strings.Insert("QuestionToUser_022", NStr("en='Do you want to upload this files: ';
		...
		|tr='Bu dosyaları yüklemek ister misiniz? :'", Lang) + Chars.LF + "%1");
#EndRegion
...
#Region Items
	...
	Strings.Insert("I_3", NStr("fr='Remplissez le document';
...
#Region FillingFromClassifiers
	...
	Strings.Insert("Class_004", NStr("ru='Сервис';
		|fr='Service';
		|en='Service';
		|tr='Servis';
		|de='Berichte'", Lang));
...
Procedure PredefinedDescriptions(Strings, CodeLanguage)
	...
	Strings.Insert("Description_A003", NStr("fr='Catalogue Divisions';
	...
	Strings.Insert("Description_A036", NStr("ru='Документ Сопоставление документа-основания взаиморасчетов с платежами';
	...
	Strings.Insert("Description_A043", NStr("fr='Document Facture d''achat';
	...
	Strings.Insert("Description_A049", NStr("fr='Document Commande client';
